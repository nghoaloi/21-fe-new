...
(function() {
  ...
  if (isWindows) {
    // nếu chúng ta sử dụng hệ điều hành Windows, chúng ta sẽ kích hoạt chức năng PerfectScrollbar
...
// Xác minh độ mờ của thanh điều hướng khi cuộn
...
// khi đầu vào được tập trung, hãy thêm lớp tập trung cho kiểu
function focused(el) {
...
// khi đầu vào được tập trung, hãy loại bỏ lớp tập trung cho kiểu
...
// người trợ giúp để thêm vào tất cả các thành phần nhiều thuộc tính
...
// thêm vào các thuộc tính đầu vào để gọi các hàm tập trung và không tập trung
...
function sidebarType(a) {
  ...
  // Xóa các lớp văn bản trắng/văn bản tối
...
// Làm mờ thanh điều hướng khi cuộn
...
// Hàm gỡ lỗi
// Trả về một hàm, miễn là nó tiếp tục được gọi thì sẽ không
// được kích hoạt. Hàm sẽ được gọi sau khi nó ngừng được gọi
// N mili giây. Nếu `ngay lập tức` được thông qua, hãy kích hoạt chức năng trên
// cạnh đầu, thay vì cạnh cuối.
...
// Thay đổi kích thước điều hướng tab
...
// Hàm xóa flex row trên thiết bị di động
if (window.innerWidth < 991) {
  total.forEach(function(item, i) {
